...
class FRAMEWORKTEMPORARY_API UFrameworkPawnComponent : public UPawnComponent, public ILuaOverriderInterface
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "slua")
