...
struct FRAMEWORKUMG_API FUIExtensionPointHandle
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct FRAMEWORKUMG_API FUIExtensionHandle
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class FRAMEWORKUMG_API UUIExtensionSubsystem : public UWorldSubsystem
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class FRAMEWORKUMG_API UUIExtensionHandleFunctions : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
UCLASS()
class FRAMEWORKUMG_API UUIExtensionPointHandleFunctions : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
