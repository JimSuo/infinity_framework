...
{
	SuspendInputToken = bSuspendInputUntilComplete ? UUIManagerBPFunctionLibrary::SuspendInputForPlayer(OwningPlayer.Get(), InputFilterReason_Template) : NAME_None;
	...
	StreamingHandle->BindCancelDelegate(FStreamableDelegate::CreateWeakLambda(this,
		[this]()
		{
			UUIManagerBPFunctionLibrary::ResumeInputForPlayer(OwningPlayer.Get(), SuspendInputToken);
		})
	);
}
