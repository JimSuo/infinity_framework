...
#include "PlayerInputKey.generated.h"
...
class FRAMEWORKGAMECORE_API UPlayerInputKey : public UCommonUserWidget
{
	GENERATED_BODY()

public:
	UPlayerInputKey(const FObjectInitializer& ObjectInitializer);
...
private:
	...
	void HandlePlayerControllerSet(UFrameworkLocalPlayer* LocalPlayer, APlayerController* PlayerController);
